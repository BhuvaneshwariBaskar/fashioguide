...
import { updateProfile } from "../axios/user.axios";
...
const Profile = ({ user }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await updateProfile(user.user_id, name, country, phone, gender,address, pincode);
            ...
            <div className="w-[80%] h-[80%] bg-white p-5">
              ...
              <div className="flex justify-between items-center relative py-5">
                <select
                  ...
                  value={country} // Use value prop to control the selected value
